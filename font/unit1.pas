...
{$ELSE}
uses {$IFDEF LCLCocoa}retinahelper,{$ENDIF} {$IFDEF COREGL}glcorearb, {$ELSE}gl, glext, {$ENDIF} OpenGLContext, gl_core_utils, VectorMath, glfont,{$IFDEF myTextures}gltexture,{$ENDIF} SimdUtils;
{$ENDIF}
